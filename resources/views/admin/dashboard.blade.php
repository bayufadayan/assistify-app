...
@section('content')
    <h1 style="text-align: center; padding-block: 20px;">---- Dashboard Admin ----</h1>
            ...
            <div class="col-8">
                <div class="card myfont">
                    <div class="card-header d-flex justify-content-center fw-bold border-0 fs-4"
                        style="background: #73040F; color: white;">
                        Fitur Admin
                    </div>
                    <div class="card-body">
                        <ul class="list-group">
                            <li class="list-group-item py-2 fs-5"><a href="/admin/upload"
                                    class="text-decoration-none text-danger">Upload Data Mahasiswa</a></li>
                            <li class="list-group-item py-2 fs-5"><a href="/user/upload-pendaftar"
                                    class="text-decoration-none text-danger">Upload Data Pendaftar</a></li>
                            <li class="list-group-item py-2 fs-5"><a href="/admin/results"
                                    class="text-decoration-none text-danger">Lihat Hasil Klastering</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li class="list-group-item py-2 fs-5 mb-3"
                                style="background-color: #4164ff; border-radius: 10px;"><a
                                    href="/user/results-pendaftar" class="text-decoration-none text-white">Lihat
                                    Pendaftar</a></li>
